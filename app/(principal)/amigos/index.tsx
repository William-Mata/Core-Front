      ...
      <ScrollView keyboardShouldPersistTaps="handled" style={{ flex: 1, padding: 24 }}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
          ...
          <View style={{ flexDirection: 'row', gap: 8 }}>
            <Botao titulo={t('documentacao.acao')} onPress={() => router.push('/amigos/documentacao')} tipo="secundario" />
            <Botao titulo={t('amigos.acoes.convidar')} onPress={() => router.push('/amigos/convite')} tipo="primario" />
          </View>
        </View>
