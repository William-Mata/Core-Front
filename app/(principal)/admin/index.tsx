...
const atalhos = [
  { rota: '/admin/usuarios', icone: '\uD83D\uDC64', titulo: 'admin.usuarios.lista' },
  { rota: '/admin/documentos', icone: '\uD83D\uDCD6', titulo: 'admin.documentacao.gerenciar' },
  { rota: '/admin/avisos', icone: '\uD83D\uDCE3', titulo: 'admin.avisos.titulo' },
  { rota: '/admin/simulacao', icone: '\uD83D\uDD04', titulo: 'admin.simulacao.titulo' },
  { rota: '/admin/documentacao', icone: '\u2139\uFE0F', titulo: 'documentacao.acao' },
] as const;
