...
export default function TelaReembolso() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: COLORS.bgPrimary }}>
      ...
      >
        <View style={{ width: 42 }} />
        <Text style={{ flex: 1, textAlign: 'center', color: COLORS.accent, fontSize: 18, fontWeight: 'bold' }}>{t('financeiro.reembolso.titulo')}</Text>
        <TouchableOpacity onPress={() => (modoFormulario === 'lista' ? router.back() : setModoFormulario('lista'))} style={{ width: 42, alignItems: 'flex-end' }}>
